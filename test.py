...
def test_2_0():
    try:
        ...
        r_squared_dum_compr = np.array([get_rsquared_sk(ind) for ind in range(0, 2**dum_num)])
        print('r_squared_dum_compr: ', r_squared_dum_compr)
        return (0)
    except Exception as e:
        print(style.red('Error: ', e))
        return (1)
...
def test_0():
    ''' Test0: test the basic functionalities of the class
        by example normalizing the dataset etc...
    '''
...
def test_1():
    ''' Test1: 
        Trying to see if the class correctly handles errors.
        If it raises an error when it should
    '''
    print('test_1_0: ', '✅' if test_1_0() == 0 else '❌')

def test_2():
    ''' Test2:
        Trying to see if the results of the class are correct.
    '''

    print('test_2_0: ', '✅' if test_2_0() == 0 else '❌')
...
if __name__ == '__main__':
    ...
    print('time to compute r_squared_dum_compr: ', time_comp)
